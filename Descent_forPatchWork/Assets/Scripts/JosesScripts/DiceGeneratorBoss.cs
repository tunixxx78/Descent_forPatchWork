...
public class DiceGeneratorBoss : MonoBehaviour
{
    public Button btn;
    ...
    IEnumerator AnimateRoll(int cycles)
    {
        ...
        GetComponentInParent<DiceFunctionalityManagerBoss>().SetDiceEyeFunctionalitiesBoss(diceResult);
        GetComponentInParent<DiceFunctionalityManagerBoss>().SetDiceEyeCommandBoss(diceResult);
